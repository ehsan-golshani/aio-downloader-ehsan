#!/usr/bin/env python3
"""
Telegram Channel Archiver - نسخه نهایی برای مخزن aio-downloader-ehsan
- پشتیبانی کامل از فایل و ویدیو
- ذخیره در telegram/data/{channel}/page_*.md
- دانلود مدیا در telegram/content/
"""
...
print("=" * 50)
print("🚀 Telegram Archiver - نسخه نهایی (aio-downloader-ehsan)")
